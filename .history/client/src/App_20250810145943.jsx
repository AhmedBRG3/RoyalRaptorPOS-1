      ...
      <div className="flex gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            {products.map((p) => (
              ...
              >
                ...
                <button className="mt-2 btn bg-blue-500 text-white p-2 rounded-lg" onClick={() => addToCart(p)}>
                  Add
                </button>
              </div>
            ))}
        ...
        <div className="w-full max-w-sm">
          ...
          {cart.length === 0 ? (
            ...
            <div className="cart w-500 h-auto border border-gray-500 p-5 rounded-lg">
              {cart.map((i) => (
                <div
                  key={i.productId}
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      className="btn bg-blue-400 text-white p-2 rounded-lg"
