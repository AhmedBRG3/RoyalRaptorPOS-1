          ...
          <tbody>
            {products.map((p) => (
              <tr key={p._id} className="border-b">
                ...
                <td className="p-2 w-1/6 text-center flex flex-col items-center content-center justify-center">
                  <button
                    onClick={() => onEdit(p)}
                    disabled={saving}
                    className="bg-yellow-500 mb-1 text-white px-2 py-1 rounded-xl hover:bg-yellow-600 flex items-center gap-1 disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="bg-red-600 text-white px-2 py-1 rounded-xl hover:bg-red-700 flex items-center gap-1 disabled:opacity-50"
                  >
