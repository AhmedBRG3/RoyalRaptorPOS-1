          ...
          <tbody>
            {products.map((p) => (
              <tr key={p._id} className="border-b">
                ...
                <td className=" p-2 flex flex-col gap-2 items-center justify-center w-1/6 ">
                  <button
                    onClick={() => onEdit(p)}
                    disabled={saving}
                    className="bg-yellow-500 text-white px-2 py-1 rounded-xl hover:bg-yellow-600 flex items-center gap-1 disabled:opacity-50"
                  >
