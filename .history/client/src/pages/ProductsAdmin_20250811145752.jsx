              ...
              <tr key={p._id} className="border-b">
                ...
                <td className=" p-2 flex gap-2 items-end justify-start w-1/6 text-center">
                  <button
                    onClick={() => onEdit(p)}
                    disabled={saving}
                    className="bg-yellow-500 text-white px-1 py-1 rounded hover:bg-yellow-600 flex items-center gap-1 disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="bg-red-600 text-white px-1 py-1 rounded hover:bg-red-700 flex items-center gap-1 disabled:opacity-50"
                  >
