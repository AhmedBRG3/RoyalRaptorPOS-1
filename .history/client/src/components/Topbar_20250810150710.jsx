...
function NavButton({ href, children }) {
  return (
    <button
      ...
      className="text-white hover:text-black hover:bg-gray-100 px-4 py-2 text-sm rounded-lg transition-colors"
      style={{
        backgroundColor: window.location.href == href ? "white" : "black"
      }}
    >
      {children}
    </button>
