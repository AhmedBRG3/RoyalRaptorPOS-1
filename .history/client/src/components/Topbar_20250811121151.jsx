    ...
    <div className="fixed top-0 inset-x-0 z-50 bg-black backdrop-blur-md border-b border-gray-200 shadow-sm">
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-2 text-white">
          ...
          <NavButton href="/sales" icon={<ShoppingCart className="w-4 h-4 mr-1" />}>
            Sales
          </NavButton>

          {isAdmin && (
            <>
              <NavButton href="/users" icon={<Users className="w-4 h-4 mr-1" />}>
                Users
              </NavButton>
              <NavButton href="/sessions" icon={<UserCircle2 className="w-4 h-4 mr-1" />}>
                Sessions
              </NavButton>
              <NavButton href="/manageProducts" icon={<Package className="w-4 h-4 mr-1" />}>
                Products
              </NavButton>
            </>
          )}
