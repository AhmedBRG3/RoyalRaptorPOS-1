...
export default function Topbar({
  ...
  return (
    <div className="fixed top-0 inset-x-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200 shadow-sm">
...
function NavButton({ href, children }) {
  return (
    <button
      ...
      className="text-gray-700 hover:bg-gray-100 px-4 py-2 text-sm rounded-lg transition-colors"
    >
      {children}
    </button>
  );
