...
import { User, ShieldCheck, ShieldX, UserCog } from "lucide-react";
    ...
    <div style={{ padding: 16 }}>
      ...
      {loading ? (
        ...
        <table className="mt-24 table-fixed w-full" style={{ borderCollapse: "collapse" }}>
          <thead>
            <tr>
              <th className="w-1/3 text-center" style={{ textAlign: "center", padding: 8, borderBottom: "1px solid #ccc" }}>
          ...
          <tbody>
            {users.map((u) => (
              <tr key={u._id}>
                <td className="w-1/3 text-center" style={{ padding: 8, textAlign: "center" }}>{u.username}</td>
                <td className="w-1/3 text-center" style={{ padding: 8, textAlign: "center" }}>
